...
function Security() {
  ...
  const [searchValue, setSearchValue] = useState('security'); // Default search term
  ...
  return (
    <>
<h3 className="text-light fs-1 bg-dark m-0 p-4 text-center">Security News</h3>

<div className="home-container mt-0 bg-dark">
{/* Search section */}
